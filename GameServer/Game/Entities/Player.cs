...
public partial class Player : Entity, IContainer
{
    ...
    public bool ValidTime(int clientTime)
    {
        ...
        if (clientDiff < 0 || serverDiff < 0 || clientDiff > Constants.MaxLatencyMS || serverDiff > Constants.MaxLatencyMS)
            return false;

        if (startDiff > Constants.MaxLatencyMS)
            return false;
    ...
    public bool TooLongSinceLastValidation()
    {
        ...
        return serverDiff > Constants.MaxLatencyMS;
    }
